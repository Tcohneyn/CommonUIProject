...
namespace FrontendGameplayTags
{
	...
	COMMONUIPROJECT_API UE_DECLARE_GAMEPLAY_TAG_EXTERN(Frontend_Widget_KeyRemapScreen);
	COMMONUIPROJECT_API UE_DECLARE_GAMEPLAY_TAG_EXTERN(Frontend_Widget_CreditScreen);
